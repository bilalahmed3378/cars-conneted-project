...
struct updateCarResponseModel : Codable {
    
    
    let successful : Bool
    let code : Int
    let message : String
    let data: updateCarDataModel?
    ...
    init(from decoder: Decoder) throws {
        ...
        do{
            data = try container.decode(updateCarDataModel?.self, forKey: .data) ?? nil
        } catch{
            data = nil
        }
...
struct updateCarDataModel : Codable {
    ...
    let lovedBy: [String]
    let sharedBy: [String]
    let images: [updateCarDataImageModel]
    ...
    init(from decoder: Decoder) throws {
        ...
        do{
            images = try container.decode([updateCarDataImageModel]?.self, forKey: .images) ?? []
        } catch{
            images = []
        }
...
struct updateCarDataImageModel : Codable {
