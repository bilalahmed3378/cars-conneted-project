//
//  Post Product Vehicle Screen.swift
//  cars conneted
//
...
struct Post_Product_Vehicle_Screen: View {
            ...
            ScrollView(.vertical, showsIndicators: false){
                ...
                HStack{
                    Image("unsplash_AHnhdjyTNGM")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
                        .frame(width: UIScreen.widthBlockSize*92, height: 210)
                }
                .padding(.top)
...
struct Post_Product_Vehicle_Screen_Previews: PreviewProvider {
    static var previews: some View {
        Post_Product_Vehicle_Screen()
    }
}
