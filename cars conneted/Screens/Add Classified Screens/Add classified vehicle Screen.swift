//
//  Add classified vehicle Screen.swift
//  cars conneted
//
...
struct Add_classified_vehicle_Screen: View {
    ...
    var body: some View {
        VStack{
            ...
            ScrollView(.vertical, showsIndicators: false){
                ...
                HStack{
                    TextField("Vehicle",text:$category)
...
struct Add_classified_vehicle_Screen_Previews: PreviewProvider {
    static var previews: some View {
        Add_classified_vehicle_Screen()
    }
}
