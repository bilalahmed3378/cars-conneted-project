...
struct Setup_Garage_Screen: View, MyLocationReceiver {
    
    @StateObject var setupGarageApi = SetupGarageApi()
    ...
    var body: some View {
        ...
        VStack{
            ...
            if(self.setupGarageApi.isLoading){
                
                ProgressView()
                    .padding()
                    .onDisappear{
                        if(self.setupGarageApi.isApiCallDone && self.setupGarageApi.isApiCallSuccessful){
                            
                            if(self.setupGarageApi.garageSetupSuccessfully){
                        ...
                        else if(self.setupGarageApi.isApiCallDone && (!self.setupGarageApi.isApiCallSuccessful)){
                ...
                Button{
                    ...
                    if (self.garageName.isEmpty){
                        ...
                        self.setupGarageApi.setupGarage(garageName: self.garageName, isPublic: self.isPublic, lat: self.latitude, long: self.longitude, address: self.address)
